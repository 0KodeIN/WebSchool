...
Route::post('/getMarkTable', [MarksController::class, 'GetMarkTable']);
Route::post('/getTeacherTable', [MarksController::class, 'GetMarksStudents']);
Route::post('/getLessonMarks', [MarksController::class, 'getLessonMarks']);
